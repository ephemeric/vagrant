...
docker run -d --rm --name loggen -v $PWD/upload/scripts:/vagrant/scripts -v $PWD/upload/log-generator:/vagrant/log-generator -v $PWD/upload/splunk/etc/apps/fortigate/samples:/vagrant/splunk/etc/apps/fortigate/samples localhost/lyftdata/loggen:0.0.1 /vagrant/scripts/provision_log-generator_fortigate.sh
